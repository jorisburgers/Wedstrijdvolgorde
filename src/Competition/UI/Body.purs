...
import Competition.UI.ImportExport as ImportExport
...
type ChildSlots =
  ...
  , importExport :: ImportExport.Slot PageAction
  )
...
render state = do
  case state.page of
    ...
    ImportExportPage -> HH.slot ImportExport.slot unit ImportExport.component unit (\x -> x)
